...
export const HomeIcon = () => {
    return <svg xmlns="http://www.w3.org/2000/svg" className={styles.colorOfParent} viewBox="0 0 44 44" width="24" height="24" role="img" aria-labelledby="a2foy4r4dt7lm8s14fip675ruoxgoz2h" ><title id="a2foy4r4dt7lm8s14fip675ruoxgoz2h">Home</title>
                <g>
