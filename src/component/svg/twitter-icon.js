...
export const TwitterIcon = () => {
    return <svg xmlns="http://www.w3.org/2000/svg" className={styles.colorOfParent} width="24" height="24" viewBox="0 0 24 24" role="img" aria-labelledby="a5mu8lm5xgbs6puqkc3338aa4u9z3fq8"><title id="a5mu8lm5xgbs6puqkc3338aa4u9z3fq8">Twitter</title>
