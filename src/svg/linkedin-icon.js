...
export const LinkedinIcon = () => {
    return <svg xmlns="http://www.w3.org/2000/svg" className={styles.colorOfParent} width="24" height="24" viewBox="0 0 24 24" role="img" aria-labelledby="a8ytyh71xfshta5r7b52emjvuzm5o5es"><title id="a8ytyh71xfshta5r7b52emjvuzm5o5es">LinkedIn logo</title>
